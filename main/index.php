	...
	<div>
        ...
        <div class="container hero">
            <div class="row">
                ...
                <div class="col col-6 col-md-4 col-lg-3 p-2 text-center my-auto">
			...
			<!-- </div> -->
                ...
                <div class="col col-6 col-md-4 col-lg-3 p-2 text-center my-auto">
                	...
                	<!-- <div class="col col-6 col-md-4 col-lg-3 p-2 text-center my-auto d-flex justify-content-center"> -->
				<a href="#"><button class="btn btn-lg btn-dark btn-primary">Scheduling</button></a>
			</div>
			<div class="col col-6 col-md-4 col-lg-3 p-2 text-center my-auto">

				<a href="#"><button class="btn btn-lg btn-dark btn-primary">Social</button></a>
            </div>
        <!-- </div> -->
    </div>
    </div>
